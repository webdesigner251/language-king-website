        ...
        <>
            ...
            <section className="mb-8 lg:scroll-mt-[90px]" id="courses">
                <div className="custom-container mx-auto py-0 px-4 sm:px-[32px] z-50 border-t border-[#252525]">
                    <div className="">
                        <h2 className="text-white font-bold sm:text-[26.39px] text-lg relative  inline-block z-10 sm:my-[38px] mt-[30px] mb-[20px] stroke-heading">Our Courses</h2>
                    </div>
                    <div className="flex flex-col gap-[32px]">
                        ...
                        <div className="course-drop-shadow bg-course-black-bg hover:bg-course-black-hover-bg border-[1.5px] border-[#333434] grid items-center lg:grid-cols-2 gap-[38px] transition-all duration-300 ease group px-4 sm:px-6 py-4 sm:py-6 relative">
                            ...
                            <div className="lg:py-[16px]">
                                ...
                                <div className="pt-[12px] flex lg:flex-nowrap flex-wrap lg:gap-[31px] gap-[16px] lg:max-w-[800px]">
                                    <a href="#" className="primary-btn bg-gradient-dark leading-[28px] inline-flex justify-center items-center text-center text-white px-3 sm:py-3 py-[14px] lg:w-[50%] w-full font-semibold sm:text-xl text-lg relative z-10 shadow-[0px_4px_0px_rgba(0,0,0,0.25),_0px_3px_0px_rgba(0,0,0,0.25)]">
                                        Free E-Book
                                    </a>
                ...
                <div className="custom-container mx-auto py-0 px-4 sm:px-[32px]">
                    <div className="bg-[#252525] px-4 sm:px-8 ">
                        <div className="sm:py-10 py-7">
                            <h2 className="sm:text-2xl text-[21px] leading-normal font-bold text-white text-left mb-4">Try these FREE video lessons</h2>
                    ...
                    <div className="bg-black1 flex flex-col sm:gap-[57px] gap-[42px] sm:leading-[auto] leading-[40px] border border-white/10 group md:px-[38px] sm:px-6 px-4 md:pt-[60px] md:pb-[85px] pt-6 pb-7  relative">
                        ...
                        <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 justify-around gap-x-[20px] gap-y-[60px]">
                            <div className="text-center">
                                ...
                                <span className="text-white/50 md:text-lg sm:text-lg text-sm block max-w-[270px] mx-auto"><span className="block text-[#E9E9E9]">Video Lectures -</span> Basic to advance</span>
                            </div>
                            <div className="text-center">
                                <img src={Icon2} alt="Icon" className="mx-auto sm:mb-[25px] mb-6 sm:max-w-[88px] max-w-[78px]" />
                                <span className="text-white/50 md:text-lg sm:text-lg text-sm block max-w-[270px] mx-auto"><span className="block text-[#E9E9E9]">Study Material -</span> Templates and prediction file</span>
                            </div>
                            <div className="text-center">
                                <img src={Icon3} alt="Icon" className="mx-auto sm:mb-[25px] mb-6 sm:max-w-[88px] max-w-[78px]" />
                                <span className="text-white/50 md:text-lg sm:text-lg text-sm block max-w-[270px] mx-auto"><span className="block text-[#E9E9E9]">Class Recordings - </span>
                                    Video library of past classes</span>
                            </div>
                            <div className="text-center">
                                <img src={Icon4} alt="Icon" className="mx-auto sm:mb-[25px] mb-6 sm:max-w-[88px] max-w-[78px]" />
                                <span className="text-white/50 md:text-lg sm:text-lg text-sm block max-w-[270px] mx-auto"><span className="block text-[#E9E9E9]">AI Portal -</span>Mock Test & 5000+ exam questions</span>
                            </div>
                            <div className="text-center">
                                <img src={Icon5} alt="Icon" className="mx-auto sm:mb-[25px] mb-6 sm:max-w-[88px] max-w-[78px]" />
                                <span className="text-white/50 md:text-lg sm:text-lg text-sm block max-w-[270px] mx-auto"><span className="block text-[#E9E9E9]">Feedback -</span>
                                    Ask an Expert</span>
                            </div>
                            <div className="text-center">
                                <img src={Icon6} alt="Icon" className="mx-auto sm:mb-[25px] mb-6 sm:max-w-[88px] max-w-[78px]" />
                                <span className="text-white/50 md:text-lg sm:text-lg text-sm block max-w-[270px] mx-auto"><span className="block text-[#E9E9E9]">Live Classes - </span>
                                    Learn with other students</span>
                            </div>
                            <div className="text-center">
                                <img src={Icon7} alt="Icon" className="mx-auto sm:mb-[25px] mb-6 sm:max-w-[88px] max-w-[78px]" />
                                <span className="text-white/50 md:text-lg sm:text-lg text-sm block max-w-[270px] mx-auto"><span className="block text-[#E9E9E9]">Expert Trainers -</span>
