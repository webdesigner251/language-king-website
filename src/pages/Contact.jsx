...
const Contact = () => {
  return (
    ...
    // <>
    //   <section className="md:pt-[6.614em] pt-[6.614em] sm:mt-[-7.937em] mt-[-80px]">
    ...
    //                 Why Language King?
    //               </h3>
    //               <ul className="mt-[2.292em] sm:ps-[1.094em] gap-5 max-w-[45.635em]">
    ...
    //               </ul>
    //             </div>
    //             <div className="flex sm:gap-5 gap-3 max-w-[46.296em]">
    //               <img
    //                 src={PinkQuote}
    //                 alt="PinkQuote"
