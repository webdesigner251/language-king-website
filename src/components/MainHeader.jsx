...
const MainHeader = () => {
  ...
  return (
    <header
      className={`text-white sm:py-[32px] py-[32px] z-50 active-header ${
        isSticky
    ...
    >
      <div className="custom-container mx-auto py-0 px-4 sm:px-[32px]">
        <div className="flex items-center justify-between relative">
          {/* Left Logo */}
          <Link
            to="/language-king-website"
            className="xl:w-[40%] w-[30%] lg:flex hidden"
          >
            ...
            <nav className="hidden lg:flex justify-end items-center ">
              <ul className="flex 2xl:gap-[77px] xl:gap-[62px] gap-[32px]">
                ...
                <li className="text-center inline-flex items-center">
                  <Link
                    to="/contact"
                    className={`relative inline-flex items-center justify-center 2xl:px-[22px] 2xl:py-[10.8px] px-[15px] py-[9px] font-bold 2xl:text-[18px] text-[16px] transition-all duration-300 header-btn min-w-[180px] z-10 ${
                      isSticky
