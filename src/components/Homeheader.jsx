...
const HomeHeader = () => {
    ...
    return (
        <header className={`text-white sm:py-[32px] py-[32px] z-50  ${isSticky ? 'lg:sticky lg:top-0 lg:bg-black lg:shadow-md active-header' : 'bg-transparent relative'
            }`}>
                ...
                {isOpen && (
                    <nav className="lg:hidden fixed w-full h-full top-0 left-0 right-0 bottom-0 bg-noise-pattern z-50 sm:py-[48px] py-[32px] px-4 sm:px-[32px] bg-black">
                        ...
                        <ul className="flex flex-col justify-center items-center gap-[34px] relative">
                            ...
                            <li className="text-center inline-flex items-center">
                                <a href="#courses" className="text-white inline-flex items-center justify-center font-bold text-[32px] border-b-2 border-transparent hover:border-white transition-all duration-300">Courses</a></li>
                            <li className="text-center inline-flex items-center">
                                <Link to="/testimonials" className="text-white inline-flex items-center justify-center font-bold text-[32px] border-b-2 border-transparent hover:border-white transition-all duration-300">Testimonials</Link>
                            </li>
                            <li className="text-center inline-flex items-center">
                                <a href="#" className="text-white inline-flex items-center justify-center font-medium text-[32px] border-b-2 border-transparent hover:border-white transition-all duration-300 [text-shadow:0px_4px_0px_#000000]">Contact us</a>
                            </li>
                        </ul>
