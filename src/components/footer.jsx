            ...
            <footer className="bg-dark pt-[67px]">
                <div className="custom-container mx-auto py-0 px-4 sm:px-[38px]">
                    <div className="border-t border-[#252525]">
                                ...
                                <div className="flex lg:flex-nowrap flex-wrap justify-between sm:gap-8 gap-[33px]">
                                    <div className="lg:w-auto w-full flex flex-col sm:gap-[40px] gap-[22px]">
                                        ...
                                        <ul className="flex flex-col gap-[22px]">
                                            <li>
                                                <a href="mailto:info@languageking.com.au" className="flex items-center gap-4 text-[#919191] font-semibold text-xl">
                                                    <img src={Email} className="w-10 h-10 " />
                                                    info@languageking.com.au
                                                </a>
                                            </li>
                                            <li>
                                                <a href="tel:+61488876999" className="flex items-center gap-4 text-[#919191] font-semibold text-xl">
                                                    <img src={Phone} className="w-10 h-10 " />
                                                    +61 488 876 999
                                                </a>
                                            </li>
                                            <li>
                                                <span className="flex items-center gap-4 text-[#919191] font-semibold text-xl">
                                    ...
                                    <div className="lg:w-auto sm:w-[30%] w-full flex flex-col sm:gap-[40px] gap-[22px]">
                        ...
                        <div className="pb-[54px] border-b border-white/80">
                            <h5 className="s:text-[22px] text-base text-[#8B8C8D]">Disclaimer - Language King is an independent coaching provider for the NAATI CCL and PTE tests. We are not affiliated with, endorsed by, or sponsored by NAATI or PTE. All test applications must be made directly with NAATI or PTE.</h5>
                        </div>
                        <div className="text-center py-[48px]">
                            <a href="#" className="min-h-[72px] align-middle inline-flex items-center justify-center text-center primary-btn bg-gradient-primary text-black px-3 py-3 sm:w-auto w-full min-w-[398px] mx-auto font-bold sm:text-xl text-lg relative z-10">
                                Get a Callback
                            </a>
                        </div>
                    </div>
