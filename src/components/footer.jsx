                ...
                <div className="custom-container mx-auto py-0 px-0 sm:px-[32px]">
                    ...
                    <div className="border border-[#333434] mb-[38px] sm:border-x-1 border-x-0">
                            ...
                            <div className="flex xl:flex-nowrap flex-wrap sm:gap-8 gap-[33px]">
                                <div className="w-full flex lg:flex-nowrap flex-wrap justify-between sm:gap-8 gap-[33px]">
                                        ...
                                        <ul className="flex sm:flex-col flex-wrap 2xl:gap-[22px] gap-[18px]">
                                            <li>
                                                <a href="#" className="flex items-center gap-4 text-[#919191] group font-semibold text-xl transition-all duration-300 ease hover:text-white/80">
                                                    <img src={AppleImg} alt="Image" className="group-hover:hidden flex 2xl-max-w-[150px] sm:max-w-[120px] max-w-[130px] transition-all duration-300 ease" />
                                                    <img src={AppleImg1} alt="Image" className="hidden group-hover:flex 2xl-max-w-[150px] sm:max-w-[120px] max-w-[130px] transition-all duration-300 ease" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" className="flex items-center gap-4 text-[#919191] group font-semibold text-xl transition-all duration-300 ease hover:text-white/80">
                                                    <img src={GoogleImg} alt="Image" className="group-hover:hidden flex 2xl-max-w-[150px] sm:max-w-[120px] max-w-[130px] transition-all duration-300 ease" />
                                                    <img src={GoogleImg1} alt="Image" className="hidden group-hover:flex 2xl-max-w-[150px] sm:max-w-[120px] max-w-[130px] transition-all duration-300 ease" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" className="flex items-center gap-4 text-[#919191] group font-semibold text-xl transition-all duration-300 ease hover:text-white/80">
                                                    <img src={WindowsImg} alt="Image" className="group-hover:hidden flex 2xl-max-w-[150px] sm:max-w-[120px] max-w-[130px] transition-all duration-300 ease" />
                                                    <img src={WindowsImg1} alt="Image" className="hidden group-hover:flex 2xl-max-w-[150px] sm:max-w-[120px] max-w-[130px] transition-all duration-300 ease" />
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="sm:hidden flex flex-col gap-[24px] w-full">
                                        <h4 className="text-white font-bold 2xl:text-[24px] text-[22px]">Follow Us</h4>
                                            ...
                                            <li>
                                                <a href="#" className="bg-[#2E2D2D] rounded-full w-[42px] h-[42px] flex items-center justify-center p-3 transition-all ease duration-300 group hover:bg-white">
                                                    <svg className="w-auto h-full" width="13" height="26" viewBox="0 0 13 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M9.27116 4.69287H12.042V0.583496H8.50553V0.599121C3.8597 0.770997 2.90137 3.32829 2.82324 6.03662H2.80762V8.88558H0.0419922V12.995H2.80762V25.4897H7.77637V12.995H11.3389L12.042 8.88558H7.77637V6.3335C7.77637 5.42725 8.39616 4.69287 9.27116 4.69287Z" fill="white" className="fill-white group-hover:fill-black" />
                                                    </svg>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" className="bg-[#2E2D2D] rounded-full w-[42px] h-[42px] flex items-center justify-center p-3 transition-all ease duration-300 group hover:bg-white">
                                                    <svg className="w-auto h-full" width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className=" flex items-center sm:justify-between justify-center 2xl:py-[36px] py-[18px] px-[38px] ">
                            <span className="font-medium 2xl:text-lg tex-base sm:text-start text-center text-white [text-shadow:0_0_16px_rgba(255,255,255,0.77)]">Copyright @ 2025 Language King</span>

                            <ul className="sm:flex hidden gap-5 2xl:pe-[50px] md:pe-[70px] pe-0">
                                <li>
                                    <a href="#" className="bg-[#2E2D2D] rounded-full w-[42px] h-[42px] flex items-center justify-center p-3 transition-all ease duration-300 group hover:bg-white">
                                        <svg className="w-auto h-full" width="13" height="26" viewBox="0 0 13 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9.27116 4.69287H12.042V0.583496H8.50553V0.599121C3.8597 0.770997 2.90137 3.32829 2.82324 6.03662H2.80762V8.88558H0.0419922V12.995H2.80762V25.4897H7.77637V12.995H11.3389L12.042 8.88558H7.77637V6.3335C7.77637 5.42725 8.39616 4.69287 9.27116 4.69287Z" fill="white" className="fill-white group-hover:fill-black" />
